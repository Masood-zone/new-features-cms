...
export const prepaymentController = {
  ...
  getByStudentId: catchAsync(async (req: Request, res: Response) => {
    ...
    const prepayments = await prepaymentService.getPrepaymentsByStudentId(
      studentId
    );
    res.json(prepayments);
  }),
  ...
  getByClassId: catchAsync(async (req: Request, res: Response) => {
    ...
    const prepayments = await prepaymentService.getPrepaymentsByClassId(
      classId
    );
    res.json(prepayments);
  }),
  ...
  getActiveByStudentId: catchAsync(async (req: Request, res: Response) => {
    const studentId = Number.parseInt(req.params.studentId);
    const prepayments = await prepaymentService.getActivePrepaymentsByStudentId(
      studentId
    );
    res.json(prepayments);
  }),
  ...
  getActiveByClassId: catchAsync(async (req: Request, res: Response) => {
    const classId = Number.parseInt(req.params.classId);
    const prepayments = await prepaymentService.getActivePrepaymentsByClassId(
      classId
    );
    res.json(prepayments);
  }),
  ...
  getClassPrepaymentStatus: catchAsync(async (req: Request, res: Response) => {
    ...
    const status = await prepaymentService.getClassPrepaymentStatus(
      classId,
      date
    );
    res.json(status);
  ...
  create: catchAsync(async (req: Request, res: Response) => {
    const { studentId, classId, amount, startDate, endDate } = req.body;
    ...
    if (!studentId || !classId || !amount || !startDate || !endDate) {
  ...
  checkStudentPrepayment: catchAsync(async (req: Request, res: Response) => {
    ...
    const hasActivePrepayment = await prepaymentService.hasActivePrepayment(
      studentId,
      date
    );
